...
  { name: 'Jan', sales: 2400 }, { name: 'Feb', sales: 3100 }, { name: 'Mar', sales: 2800 }, { name: 'Apr', sales: 3500 }, { name: 'May', sales: 2900 }, { name: 'Jun', sales: 4200 }, { name: 'Jul', sales: 4800 },
];
const monthlyTargetData = [
  { name: 'Achieved', value: 75 }, { name: 'Remaining', value: 25 },
];
...
            </div>
          </div>
          <p className="text-sm font-medium text-center text-green-500">This Month +5%</p>
        </div>
